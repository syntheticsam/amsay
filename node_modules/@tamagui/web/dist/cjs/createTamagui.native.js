...
`).concat(JSON.stringify(variable, null, 2)));
    ...
    var themesIn = _object_spread({}, configIn.themes), dedupedThemes = foundThemes ?? getThemesDeduped(themesIn), themes = (0, import_proxyThemeToParents.proxyThemesToParents)(dedupedThemes);
    return {
      themes,
      cssRuleSets,
