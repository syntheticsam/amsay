...
var import_constants = require("@tamagui/constants"), React = __toESM(require("react")), import_ComponentContext = require("../contexts/ComponentContext"), import_useMedia = require("../hooks/useMedia"), import_ThemeProvider = require("./ThemeProvider"), import_useDidHydrateOnce = require("../hooks/useDidHydrateOnce"), import_jsx_runtime = require("react/jsx-runtime");
function TamaguiProvider({
  ...
  return (0, import_useMedia.setupMediaListeners)(), import_constants.isClient && ((0, import_useDidHydrateOnce.useDidHydrateOnceRoot)(), React.useInsertionEffect(() => {
