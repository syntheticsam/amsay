...
var useComponentState = function(props, param, staticConfig, config) {
  ...
  var hasEnterState = hasEnterStyle || isEntering, didHydrateOnce = useDidHydrateOnce(), initialState = hasEnterState || !didHydrateOnce && hasRNAnimation ? (
...
function createComponent(staticConfig) {
  ...
  var component = /* @__PURE__ */ forwardRef(function(propsIn, forwardedRef) {
    ...
    var mediaState = useMedia(stateRef, componentContext);
...
function spacedChildren(props) {
  ...
  if (!(hasSpace || hasSeparator || isZStack))
    return children;
  var childrenList = Children.toArray(children), len = childrenList.length;
    ...
    for (var _iterator = childrenList.entries()[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = !0) {
      ...
      if (!isEmpty && /* @__PURE__ */ React.isValidElement(child) && (!((_child_type = child.type) === null || _child_type === void 0) && _child_type.shouldForwardSpace) && (child = /* @__PURE__ */ React.cloneElement(child, {
        ...
        next && !isUnspaced(next) && (separator ? (hasSpace && final.push(createSpacer({
          ...
          space,
          spaceFlex
        })), final.push(/* @__PURE__ */ React.isValidElement(separator) ? /* @__PURE__ */ React.cloneElement(separator, {
