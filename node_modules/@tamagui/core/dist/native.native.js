      ...
      var next = function() {
        if (component[Decorated]) {
          ...
          for (var key in component) {
            var v = component[key];
            _[key] = v && typeof v == "object" ? _object_spread2({}, v) : v;
          }
        }
        return component;
      }();
...
var require_index_native6 = __commonJS({
  "../use-did-finish-ssr/dist/cjs/index.native.js"(exports2, module2) {
    ...
    function useDidFinishSSR(value) {
      return value ?? !0;
      var _useState, hydrated, setHydrated;
    }
              ...
              if (val != null && !(key in usedKeys)) {
                ...
                if (isMedia) {
                  ...
                  if ((hasSpace || !shouldDoClasses) && (Array.isArray(hasMedia) || (hasMedia = []), hasMedia.push(mediaKeyShort)), shouldDoClasses) {
                    ...
                    if (!isThemeMedia && !isPlatformMedia && !isGroupMedia && !mediaState2[mediaKeyShort]) continue;
...
var require_createComponent_native = __commonJS({
  "../web/dist/cjs/createComponent.native.js"(exports2, module2) {
    ...
    var cancelTouches, useComponentState = function(props, param, staticConfig, config) {
      ...
      var setStateShallow = (0, import_createShallowSetState.createShallowSetState)(setState, disabled, !0, props.debug);
...
var require_createVariables_native = __commonJS({
  "../web/dist/cjs/createVariables.native.js"(exports2, module2) {
    ...
    var import_helpers = require_index_native4(), import_createVariable = require_createVariable_native(), cache = /* @__PURE__ */ new WeakMap(), createVariables = function(tokens) {
...
var require_useIsTouchDevice_native = __commonJS({
  "../web/dist/cjs/hooks/useIsTouchDevice.native.js"(exports2, module2) {
    ...
    var import_constants = require_index_native3(), import_use_did_finish_ssr = require_index_native6(), useIsTouchDevice = function() {
